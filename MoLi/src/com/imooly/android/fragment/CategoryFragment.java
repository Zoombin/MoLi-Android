...
public class CategoryFragment extends BaseFragment implements OnClickListener {
	...
	private LoadingView layout_loading_category;
	...
	private void createView(View v) {
		...
		layout_loading_category = (LoadingView) v.findViewById(R.id.layout_loading_category);
		...
		if (rspgoodsclasslist != null) {
			...
			layout_loading_category.setVisibility(View.GONE);
			layout_loading_category.postHandle(LoadingView.success);
		...
		Api.getGoodsClassifyList(mActivity, categorylastpulltime, null,
				new NetCallBack<ServiceResult>() {
					...
					public void failed(String msg) {
						layout_loading_category.postHandle(LoadingView.network_error);
						layout_loading_category.setL(new RequestWebListener() {
	...
	private void setCategoryInfo(RspGoodsClassList entity) {
		if (category_one.getAdapter() != null) {
			if (entity.data != null) {
				((CategoryNewOneAdapter) category_one.getAdapter()).refrashData(entity.data.getClassifylist());
			}
			return;
		}
		if (entity.data != null) {
			List<GoodsClassify> categorylist = entity.data.getClassifylist();
			...
			category_one.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					List<GoodsClassify> categorylist = oneadapter.getData();
					if(categorylist != null){
