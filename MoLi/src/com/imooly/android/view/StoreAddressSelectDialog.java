...
import com.imooly.android.fragment.StoreFragmenttemp;
	...
	private void initPopWin(final Context context) {
		...
		ll_curcity.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				((Activity) context).startActivityForResult(new Intent(context, StoreCityChangeActivity.class), StoreFragmenttemp.SELECT_CITY);
			}
		});
