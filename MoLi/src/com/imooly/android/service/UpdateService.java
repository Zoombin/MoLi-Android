...
public class UpdateService extends Service {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DOWN_COMPLETED:
				...
				intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP); // 防止有相同的activity
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		Log.d("xxx", "onStartCommand...");
			...
			Log.d("xxx", "创建文件开始");
			// 创建文件
			FileUtils.getInstance(this).createAppFile(mAppName);
			Log.d("xxx", "创建文件结束");
	...
	public void createNotification() {
		 ...
		 */
		mNotification.icon = R.drawable.app_icon; // 不设置显示不了notification
		...
		mUpdateIntent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);  // activity启动方式
