...
import com.imooly.android.view.FullScreenImageDialog;
...
public class StoreCommentHListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, final ViewGroup parent) {
		...
		final String imgurl = (String) getItem(position);
		ImageLoader.getInstance().displayImage(imgurl, tag.store_comment_pic);
		
		tag.store_comment_pic.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				FullScreenImageDialog.show(parent.getContext(), imgurl);
			}
		});
