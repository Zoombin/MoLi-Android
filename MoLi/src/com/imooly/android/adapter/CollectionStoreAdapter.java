...
public class CollectionStoreAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Store ety = (Store) getItem(position);
		if (ety != null) {
			ImageLoader.getInstance().displayImage(ety.getStoreimage(), tag.image_left, defaultOptions);
			tag.textTitle.setText(ety.getStorename());
		}
		if (edit) {
