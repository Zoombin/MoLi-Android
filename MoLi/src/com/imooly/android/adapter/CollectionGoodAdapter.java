...
//	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			tag.textTip = (TextView) convertView.findViewById(R.id.text_tip);
		...
		if (ety != null) {
			...
			tag.textPrice.setText("价格：￥" + fnum.format(ety.getPrice()));
			
			if (ety.getOnsale() == 0) {  // 处理商品失效
				tag.textTip.setVisibility(View.VISIBLE);
			}else {
				tag.textTip.setVisibility(View.GONE);
			}
		}
