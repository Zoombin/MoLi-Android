...
public class CollectionActivity extends BaseActivity implements OnClickListener {
	...
	private void getCollectionNumber() {
		Api.myCollectionNumbers(self, "正在获取数据...", new NetCallBack<ServiceResult>() {
			...
			public void success(ServiceResult rspData) {
				...
				text_good_number.setText(String.format("%d件商品", data.goods));
				text_flag_store_number.setText(String.format("%d个店铺", data.store));
				text_store_number.setText(String.format("%d个实体店", data.business));
			}
