...
public class AgreementActivity extends BaseActivity implements OnClickListener {
	...
	// 版本说明
	private static final String URL_VERSION_DESC = "public/versiondesc?deviceos=Android";
	
	private static final String URL_REGISTER = "public/registterm";
	...
	private void initData() {
		...
		if (TextUtils.equals(extra, EXTRA_VIP)) {
			...
			mWebView.loadUrl(NetUtils.BASE_URL + URL_VIP);
			Log.d("xxx", NetUtils.BASE_URL + URL_VIP);
			return;
		}
		
		if (TextUtils.equals(extra, EXTRA_REGISTER)) {
			tv_title.setText("魔力网用户注册协议");
			mWebView.loadUrl(NetUtils.BASE_URL + URL_REGISTER);
			Log.d("xxx", NetUtils.BASE_URL + URL_REGISTER);
			return;
		}
