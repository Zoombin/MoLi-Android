...
public class CollectionGoodActivity extends BaseActivity implements OnClickListener, OnCheckedChangeListener, OnItemClickListener {
	...
	private void initView() {
		...
		mListView = (PullUpListView) findViewById(R.id.list_collection_good);
	...
	private void getData() {
		Log.d("xxx", "getData>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
		// 获取收藏列表
		Api.getMyCollectionGoods(self, curPage, String.valueOf(8), new NetCallBack<ServiceResult>() {
			@Override
