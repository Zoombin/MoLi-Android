 ...
 * 
 */
public class TradePwdFind2Activity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_trade_pwd_find2);
	...
	private void setTradPwd() {
		...
		String firstPwd = edit_setting.getText().toString();
		String confirmPwd = edit_sure.getText().toString();
		...
		Api.setNewTradePwd(self, phone, code, firstPwd, confirmPwd, new NetCallBack<ServiceResult>() {
