...
public class OrderAdapter extends BaseAdapter implements OnClickListener {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (ety != null) {
			...
			tag.order_item_top_price.setText("￥" + ety.getTotalprice() + "");
	...
	OpHubClickListener opClickListener = new OpHubClickListener() {
		...
		public void onClick(Object parentEntity, Object Entity) {
			...
			if ("OP004".equals(code)) {
				// OP004 提醒卖家发货
				OrderOperate.noticeOrder(context, ety.getOrderno(), null);
			}
			...
			if ("OP007".equals(code)) {
				// OP007 领代金券
				OrderOperate.takevoucher(context, ety.getOrderno(), null);
			}
			...
			if ("OP009".equals(code)) {
				...
				OrderOperate.takedelay(context, "normal", ety.getOrderno(), "", "", "", null);
			}
		}
	};
}
